...
async def shopify_route(
    ...
    proxy:     Optional[str] = Query(None, description="host:port:user:pass"),
...
<head>
    ...
    <title>Shopify Validator — Cyber Suite PRO</title>
...
<div class="dashboard">
    ...
    <div class="main-card">
        ...
        <div class="config-strip">
            ...
            <div class="config-item">
                Proxy:
                <input type="text" id="inp-proxy" placeholder="host:port:user:pass" style="width:190px;">
            </div>
